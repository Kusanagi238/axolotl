"""StableMax integration utilities.

This module provides a StableMax-based softmax replacement and a
compatible cross-entropy loss implementation that works with StableMax
probabilities.
"""
